...
const defaultProducts = [
  { id: 'p1', name: 'តែទឹកឃ្មុំល្មុង', price: '៛8,000', priceNum: 8000, sold: 45, img: `${import.meta.env.BASE_URL}images/honey-lemon.jpg` },
  { id: 'p2', name: 'តែផ្កាម្រេច', price: '៛7,000', priceNum: 7000, sold: 38, img: `${import.meta.env.BASE_URL}images/jasmine-tea.jpg` },
  { id: 'p3', name: 'តែបូបា', price: '៛10,000', priceNum: 10000, sold: 72, img: `${import.meta.env.BASE_URL}images/boba-tea.jpg` },
  { id: 'p4', name: 'តែផ្លែឈើ', price: '៛9,000', priceNum: 9000, sold: 28, img: `${import.meta.env.BASE_URL}images/fruit-tea.jpg` },
  { id: 'p5', name: 'តែបន្សំ', price: '៛12,000', priceNum: 12000, sold: 20, img: `${import.meta.env.BASE_URL}images/herbal-detox.jpg` },
  { id: 'p6', name: 'តែបៃតង', price: '៛6,500', priceNum: 6500, sold: 55, img: `${import.meta.env.BASE_URL}images/green-tea.jpg` },
  { id: 'p7', name: 'តែទឹកដោះគោ', price: '៛8,500', priceNum: 8500, sold: 62, img: `${import.meta.env.BASE_URL}images/milk-tea.jpg` },
  { id: 'p8', name: 'តែស្វាយ', price: '៛9,500', priceNum: 9500, sold: 33, img: `${import.meta.env.BASE_URL}images/mango-tea.jpg` },
  { id: 'p9', name: 'ម៉ាឆាឡាតេ', price: '៛11,000', priceNum: 11000, sold: 41, img: `${import.meta.env.BASE_URL}images/matcha-latte.jpg` },
  { id: 'p10', name: 'តែផ្ការ័សី', price: '៛10,500', priceNum: 10500, sold: 18, img: `${import.meta.env.BASE_URL}images/rose-tea.jpg` },
]
...
export default function AdminDashboard() {
  ...
  const [newProduct, setNewProduct] = useState({ name: '', price: '', img: `${import.meta.env.BASE_URL}images/boba-tea.jpg` })
  ...
  function addNewProduct() {
    ...
    const img = newProduct.img.trim() || `${import.meta.env.BASE_URL}images/boba-tea.jpg`
    ...
    setNewProduct({ name: '', price: '', img: `${import.meta.env.BASE_URL}images/boba-tea.jpg` })
